 ...
 * ePub.js v0.3.93
 * 
 * FIGYELEM: A teljes offline működéshez másold ide az ePub.js kódját!
 * 
 * Működő letöltési link (Jobb klikk -> Mentés másként, vagy nyisd meg és másold ki):
 * https://cdn.jsdelivr.net/npm/epubjs@0.3.93/dist/epub.min.js
 * 
 * Ha a teljes, olvasható forráskódot szeretnéd (fejlesztéshez):
 * https://cdn.jsdelivr.net/npm/epubjs@0.3.93/dist/epub.js
 * 
 * Lépések:
 * 1. Nyisd meg a fenti linket.
 * 2. Jelöld ki az egészet (Ctrl+A), majd másold (Ctrl+C).
 * 3. Illeszd be ide (Ctrl+V), felülírva ezt a kommentet.
 */
...
console.warn("A 'js/libs/epub.min.js' fájl üres! Kérlek, pótold a tartalmát a fájlban található útmutató alapján.");
